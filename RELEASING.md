...
If checkout reports `couldn't find remote ref refs/tags/v0.3.3`, create and push
...
```bash
python scripts/verify-release.py --version 0.3.3 --report release-verification.json
```
