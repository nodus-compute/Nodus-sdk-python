...
from ._brief import _validate_outputs, reject_customer_runtime
...
'''
_FIELDS = {
    'command', 'image', 'model', 'peak_memory_gb',
...
def load_workload_file(path: str | Path = 'nodus.toml') -> dict[str, Any]:
    ...
    reject_customer_runtime(values)
    ...
    for key in {'model', 'compute_class', 'peak_memory_gb'}:
